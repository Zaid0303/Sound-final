...
<head>
   ...
   <!-- Favicon -->
   <link rel="shortcut icon" href="admin-sound/images/favicon.ico" />
   <!-- Bootstrap CSS -->
                        ...
                        <div class="sign-in-from w-100 pt-5 m-auto">
                           ...
                           <form class="mt-4" action="insert-login.php" method="POST">
                              ...
                              <div class="sign-info mt-3">
                                 ...
                                 <span class="dark-color d-block line-height-2">Don't have an account? <a href="signUp.php">Sign up</a></span>
                              </div>
                           </form>
                        </div>
                     </div>
