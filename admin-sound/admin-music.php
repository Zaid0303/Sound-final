                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Music Lists</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                          <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="music-trash.php"><i class="fas fa-trash"></i></a>
                           <a href="admin-add-music.php" class="btn btn-primary">Add New Music</a>
                        </div>
                     </div>
                        ...
                        <div class="table-responsive">
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              ...
                              <tbody>
                                 ...
                                 <?php 
                                 $fetch_cat_join = "SELECT * from `music` AS m INNER JOIN `categories` AS c ON m.cat_id = c.c_id where m.status = 1";

                                 $fetch_music_result = mysqli_query($connection, $fetch_cat_join);
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $row['m_artist']?></td> 
                                    <td><?php echo $row['c_year']?></td>
                                    <td><?php echo $row['m_album']?></td>
                                    <td><?php echo $row['m_genre']?></td>
                                    <td><?php echo $row['m_language']?></td>
                                    <td><img src="<?php echo 'song-img/' . $row["m_img"] ?>" height="50px" width="50px" alt="img"></td>
                                    <td><?php echo $row['m_file']?></td>
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="music-update.php?m-id=<?php echo $row["m_id"] ?>"><i class="ri-pencil-line"></i></a>

                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="music-trash.php?m-id=<?php echo $row["m_id"] ?>"><i class="fas fa-trash"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php 
