                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Trash Category Lists</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="admin-category.php" class="btn btn-primary">Back to All Category</a>
                        </div>
                     </div>
                           ...
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                             ...
                             <tbody>
                              ...
                              ?>
                                 <tr>
                                 <td>
                                          <?php echo $row['c_genre'] ?>
                                       </td>
                                       <td>
                                       <img src="<?php echo 'category/genre-img/' . $row["c_genre_img"] ?>" height="50px" width="50px" alt="img">
                                       ...
                                       <td>
                                          <img src="<?php echo 'category/artist-img/' . $row["c_artist_img"] ?>" height="50px" width="50px" alt="img">

                                       </td>
                                       <td>
                                          <?php echo $row['c_album'] ?>
                                       </td>
                                       <td>
                                         <img src="<?php echo 'category/album-img/' . $row["c_album_img"] ?>" height="50px" width="50px" alt="img">
                                       </td>
                                       <td>
                                          <?php echo $row['c_year'] ?>
                                       </td>
                                     <td>
                                        <div class="flex align-items-center list-user-action">
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Restore"  href="category-restore.php?id=<?php echo $row["c_id"] ?>"><i class="fas fa-undo-alt"></i></a>
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"  href="category-delete.php?c-id=<?php echo $row["c_id"] ?>"><i class="fas fa-trash"></i></a>
                                       </div>
                                     </td>
                                 </tr>
                                 <?php 
