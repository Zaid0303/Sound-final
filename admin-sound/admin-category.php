               ...
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                     ...
                     <div class="iq-card-header-toolbar d-flex align-items-center">
                        <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="category-trash.php"><i class="fas fa-trash"></i></a>
                  ...
                  <div class="iq-card-body">
                     <div class="table-responsive">
                        <table class="data-tables table table-striped table-bordered" style="width:100%">
                           ...
                           <tbody>
                              <?php
                              $fetch_cat_join = "SELECT * from `categories` where `status` = 1";
                              ...
                              if (mysqli_num_rows($fetch_cat_result) > 0) {
                                 while ($row = mysqli_fetch_assoc($fetch_cat_result)) {
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <img src="<?php echo 'category/genre-img/' . $row["c_genre_img"] ?>" height="50px"
                                             width="50px" alt="img">
                                       ...
                                       <td>
                                          <img src="<?php echo 'category/artist-img/' . $row["c_artist_img"] ?>" height="50px"
                                             width="50px" alt="img">
                                       ...
                                       <td>
                                          <img src="<?php echo 'category/album-img/' . $row["c_album_img"] ?>" height="50px"
                                             width="50px" alt="img">
                                       </td>
                                       <td>
                                          <?php echo $row['c_year'] ?>
                                       ...
                                       <td>
                                          <div class="flex align-items-center list-user-action">
                                             <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                                ...
                                                href="category-update.php?c-id=<?php echo $row["c_id"] ?>"><i
                                                   class="ri-pencil-line"></i></a>
                                             <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                                data-original-title="Trash"
                                                href="category-trash.php?c-id=<?php echo $row["c_id"] ?>"><i
