               ...
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                     <div class="iq-header-title">
                        <h4 class="card-title">Trash User Lists</h4>
                     </div>
                     <div class="iq-card-header-toolbar d-flex align-items-center">
                        <a href="user-list.php" class="btn btn-primary">Back to All User</a>
                     </div>
                  </div>
                  <div class="iq-card-body">
                     <div class="table-responsive">
                        <table class="data-tables table table-striped table-bordered" style="width:100%">
                           ...
                           <tbody>
                           <?php 
                                 $fetch_user = "SELECT * FROM users where status = '0'";
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a name="updated" class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Restore" href="userlist-restore.php?id=<?php echo $row['u_id'] ?>"><i class="fas fa-undo-alt"></i></a>
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="userlist-delete.php?u-id=<?php echo $row["u_id"] ?>"><i class="fas fa-trash"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php 
