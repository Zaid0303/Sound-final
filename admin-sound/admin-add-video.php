            ...
            <div class="col-sm-12">
               <div class="iq-card">
                  ...
                  <div class="iq-card-body">
                     <form action="insert-addvideo.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                           <div class="form-group col-md-6">
                              <label>Name:</label>
                              <input type="text" name="v-name" class="form-control" id="vid-name" required>
                           </div>
                           ...
                           <div class="form-group col-md-6">
                              <label>Artist:</label>
                              <input type="text" name="v-artist" class="form-control" id="vid-artist" required>
                              <!-- <select class="form-select form-control" name="v-artist" aria-label="Default select example">
                           ...
                           <div class="form-group col-md-6">
                              <label>Album:</label>
                              <input type="text" name="v-album" class="form-control" id="vid-album" required>
                              <!-- <select class="form-select form-control" name="v-album" aria-label="Default select example">
                           ...
                           <div class="form-group col-md-6">
                              <label>Genre:</label>
                              <input type="text" name="v-genre" class="form-control" id="vid-genre" required>
                              <!-- <select class="form-select form-control" name="v-genre" aria-label="Default select example">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <input type="text" name="v-language" class="form-control" id="vid-language" required>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <div class="custom-file">
                                 <input type="file" name="v-image" class="custom-file-input" id="vid-file" required>
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <div class="custom-file">
                                 <input type="file" name="v-file" class="custom-file-input" id="vid-file" required>
                                 <label class="custom-file-label" for="customFile">Choose file</label>
                              </div>
                           </div>

                        </div>
                        <input type="Submit" class="btn btn-primary" name="addvideo" id="vid-add">
