                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active active-menu">
                        ...
                        <ul id="userinfo" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle" style="">
                           ...
                           <li class="active"><a href="user-reviews-ratings.php"><i class="las la-th-list"></i>Reviews & Ratings</a></li>
                        </ul>
                     </li>
               ...
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                     <div class="iq-header-title">
                        <h4 class="card-title">User Reviews & Ratings Lists</h4>
                     </div>
                  ...
                  <div class="iq-card-body">
                     <div class="table-responsive">
                        <table class="data-tables table table-striped table-bordered" style="width:100%">
                           ...
                           <tbody>
                           <?php 
                                 $fetch_review = "SELECT * FROM review_table";
                                 $fetch_result = mysqli_query($connection, $fetch_review);
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a name="updated" class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="userlist-update.php?id=<?php echo $row['review_id'] ?>"><i class="ri-pencil-line"></i></a>
                                          <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="userlist-trash.php?u-id=<?php echo $row['review_id'] ?>"><i class="fas fa-trash"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <?php 
