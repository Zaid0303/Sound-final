               ...
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                     <div class="iq-header-title">
                        <h4 class="card-title">Trash Music Lists</h4>
                     </div>
                     <div class="iq-card-header-toolbar d-flex align-items-center">
                        <a href="admin-music.php" class="btn btn-primary">Back to All Music</a>
                     </div>
                  </div>
                     ...
                     <div class="table-responsive">
                        <table class="data-tables table table-striped table-bordered" style="width:100%">
                           ...
                           <tbody>
                              ...
                              <?php
                              $fetch_music = "SELECT * from `music` AS m INNER JOIN `categories` AS c ON m.cat_id = c.c_id where m.status = 0";
                              ...
                              ?>
                                    ...
                                    <tr>
                                       ...
                                       <td><img src="<?php echo 'song-img/' . $row["m_img"] ?>" height="50px" width="50px"
                                             alt="img"></td>
                                       <td>
                                          <?php echo $row['m_file'] ?>
                                       </td>
                                       <td>
                                          <div class="flex align-items-center list-user-action">
                                             <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                                ...
                                                href="music-restore.php?m-id=<?php echo $row["m_id"] ?>"><i
                                                   class="fas fa-undo-alt"></i></a>
                                             <a class="bg-primary" data-toggle="tooltip" data-placement="top" title=""
                                                data-original-title="Delete"
                                                href="music-delete.php?m-id=<?php echo $row["m_id"] ?>"><i
