               ...
               <div class="iq-card">
                  <div class="iq-card-header d-flex justify-content-between">
                     ...
                     <div class="iq-card-header-toolbar d-flex align-items-center">
                        <a class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Trash" href="video-trash.php"><i class="fas fa-trash"></i></a>
                  ...
                  <div class="iq-card-body">
                     <div class="table-responsive">
                        <table class="data-tables table table-striped table-bordered" style="width:100%">
                           ...
                           <tbody>
                              <?php
                              // $fetch_video = "SELECT * from `videos` AS v INNER JOIN `video_categories` AS vc ON vc.v_id = v.v_id where v.status = 1";
                              $fetch_video = "SELECT * from `videos` as v inner join `categories` as c on v.cat_id = c.c_id where v.status = 1";
                              ...
                              if (mysqli_num_rows($fetch_result) > 0) {
                                 while ($row = mysqli_fetch_assoc($fetch_result)) {
                                    ...
                                    <tr>
                                       ...
                                       <td><img src="<?php echo 'song-img/' . $row["v_img"] ?>" height="50px" width="80px"
                                             alt="img"></td>
                                       <td>
                                          <?php echo 'video-song/' . $row["v_file"] ?>
                                       </td>
                                       <td>
                                          <div class="flex align-items-center list-user-action">
                                             <a name="updated" class="bg-primary" data-toggle="tooltip" data-placement="top"
                                                title="" data-original-title="Edit"
                                                href="video-update.php?v-id=<?php echo $row["v_id"] ?>"><i
                                                   class="ri-pencil-line"></i></a>

                                             <a name="trash" class="bg-primary" data-toggle="tooltip" data-placement="top"
                                                title="" data-original-title="Trash"
                                                href="video-trash.php?v-id=<?php echo $row["v_id"] ?>"><i
