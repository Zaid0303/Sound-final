                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="admin-video.php" class="btn btn-primary">Back to All Video</a>
                           </div>
                        </div>
                           ...
                           <div class="table-responsive">
                              <table class="data-tables table table-striped table-bordered" style="width:100%">
                                 ...
                                 <tbody>
                                    ...
                                    <?php
                                       $fetch_video = "SELECT * from `videos` as v inner join `categories` as c on v.cat_id = c.c_id where v.status = 0";
                                    ...
                                    ?>
                                       ...
                                       <tr>
                                          ...
                                          <td><img src="<?php echo 'song-img/' . $row["v_img"] ?>" height="50px" width="80px" alt="img"></td>
                                          <td>
                                             <?php echo $row["v_file"] ?>
                                          </td>
                                          <td>
                                             <div class="flex align-items-center list-user-action">
                                                <a name="updated" class="bg-primary"data-toggle="tooltip" data-placement="top" title="" data-original-title="Restore"
                                                    href="video-restore.php?v-id=<?php echo $row["v_id"] ?>"><i class="fas fa-undo-alt"></i></a>
                                               
                                                <a name="trash" class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"
                                                   href="video-delete.php?v-id=<?php echo $row["v_id"] ?>"><i class="fas fa-trash"></i></a>
                                             </div>
                                          </td>
                                       </tr>
