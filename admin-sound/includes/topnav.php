            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="list-unstyled iq-menu-top d-flex justify-content-between mb-0 p-0">
                     ...
                     <li><a href="../index.php">Our Website</a></li>
                  </ul>
                  <ul class="navbar-nav ml-auto navbar-list">
                     ...
                     <li class="line-height pt-3">
                        <?php 
                        include('config.php');
                        $admin_img = "SELECT * FROM `admin`";
                        $admin_img_result = mysqli_query($connection, $admin_img);
                        if(mysqli_num_rows($admin_img_result) > 0){
                           $row = mysqli_fetch_assoc($admin_img_result) 

                        ?>
                        <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                           <img src="<?php echo 'images/admin_img/'.  $_SESSION['admin_img']?>" class="img-fluid rounded-circle" alt="admin">
                        </a>
                        <?php 
                                   }
                           ...
                           <div class="iq-card shadow-none m-0">
                              <div class="iq-card-body p-0 ">
                                 <div class="bg-primary p-3">
                                    ...
                                    <h5 class="mb-0 text-white line-height"><?php echo $_SESSION['admin_name']?></h5>
                                 ...
                                 <a href="profile-edit.php?id=<?php echo $row['admin_id'] ?>" class="iq-sub-card iq-bg-primary-hover">
                                    <div class="media align-items-center">
                                       <div class="rounded iq-card-icon iq-bg-primary">
