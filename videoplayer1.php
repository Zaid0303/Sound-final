...
<!-- video Player Media Query Section Begin -->
<style>
    .fa-heart:hover {
        color: red;
    }
...
<!-- video Player Media Query Section End -->
    ...
    <div class="container">
        <div class="row">
            ...
            if (isset($_GET['id'])) {
                ...
                $fetch = "SELECT * from `videos` as v inner join `categories` as c on v.cat_id = c.c_id where `v_id` = '$audio_id' ";
                        ...
                        <div class="col-lg-8">
                            <div class="blog__details__content">
                                <div class="blog__details__item">
                                    <video class="mt-3" controls poster="<?php echo 'admin-sound/song-img/' . $row["v_img"]; ?>">
                                        <source src="<?php echo 'admin-sound/video-song/' . $row['v_file'] ?>" type="audio/ogg">
                                        <source src="<?php echo 'admin-sound/video-song/' . $row['v_file'] ?>" type="audio/mpeg">
                                    </video>
                                    <div class="blog__details__item__text">
                                        <span>
                                            <?php echo $row['v_artist'] ?>
                                        </span>
                                        <div class="d-inline-flex p-2" id="heart-icon">
                                            <a id="fav" data-id="<?php echo $row['v_id'] ?>">
                                                <i class="fa-regular fa-heart icon" style="font-size: 30px;"></i>
                                            </a>
                                        </div>
                                        <style>
                                            .icon {
            ...
            <div class="col-lg-4 mt-5">
                <div class="blog__sidebar__item">
                    ...
                    <?php
                    $fetch_videos = "SELECT * FROM videos";
                    $fetch_result = mysqli_query($connection, $fetch_videos);
                    if (mysqli_num_rows($fetch_result) > 0) {
                        while ($row = mysqli_fetch_assoc($fetch_result)) {
                            ?>
                            <a href="videoplayer1.php?id=<?php echo $row['v_id'] ?>" class="recent__item">

                                <div class="recent__item__pic">
                                    <img src="<?php echo 'admin-sound/song-img/' . $row["v_img"]; ?>" height="70" width="110"
                                        alt="">
                                </div>
